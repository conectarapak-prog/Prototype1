          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            <div className="lg:col-span-10 space-y-12">
              <div className="flex items-center gap-8">
                ...
                <span className="text-[12px] font-mono text-teal-400 uppercase tracking-[0.6em] font-black">Distrito Tecnológico Atacama</span>
              </div>
              <h1 className="text-[9vw] lg:text-[140px] leading-[0.8] font-black tracking-tighter uppercase font-outfit">
                TARAPACÁ <br />
                <span className="text-white">PROTOTIPANDO</span> <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-amber-500">EL FUTURO</span>
              </h1>
              <div className="max-w-4xl pt-12">
                <p className="text-2xl font-light text-slate-400 leading-tight uppercase tracking-[0.2em] font-outfit">
                  La plataforma de inversión colectiva que conecta la resiliencia del norte con el capital global. Impulsamos <span className="text-teal-400 font-bold">proyectos</span> de economía circular y tecnología industrial.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="reveal py-64 relative overflow-hidden text-center">
          ...
          <div className="relative z-10 space-y-16">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              <Link to="/assistant" className="px-16 py-8 bg-white text-black font-mono text-[12px] uppercase tracking-[0.5em] font-black hover:bg-teal-500 hover:text-white transition-all shadow-2xl">Consultar Asesor IA</Link>
              <Link to="/projects" className="px-16 py-8 border border-white/10 text-[12px] font-mono uppercase tracking-[0.5em] font-black hover:bg-teal-500/10 transition-all">Ver Proyectos</Link>
            </div>
          </div>
        </section>
